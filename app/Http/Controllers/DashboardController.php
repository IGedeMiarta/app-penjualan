...
class DashboardController extends Controller
{
    public function index(){
        ...
        $lastSuccessTrx = Transaction::where('status',2)->whereMonth('created_at', $lastMonth)->sum('amount');
        $successTrxNow = Transaction::where('status',2)->whereMonth('created_at', $currentMonth)->sum('amount');
