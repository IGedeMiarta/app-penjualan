                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            ...
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-1.jpg"
                                                                alt="">
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            style="height: 30px; min-width: 30px; max-width:30px">
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-2.jpg"
                                                                alt="">
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            style="height: 30px; min-width: 30px; max-width:30px">
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-3.jpg"
                                                                alt="">
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            style="height: 30px; min-width: 30px; max-width:30px">
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-4.jpg"
                                                                alt="">
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            style="height: 30px; min-width: 30px; max-width:30px">
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-5.jpg"
                                                                alt="">
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-image"
                                                            style="height: 30px; min-width: 30px; max-width:30px">
                                                            <img src="{{ asset('app') }}/assets/images/avatars/thumb-6.jpg"
                                                                alt="">
                                                        </div>
